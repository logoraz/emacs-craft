;;;; raz-core.el --- Core non-external Packages -*- lexical-binding: t -*-

;;; Author: Erik P. Almaraz

;;; Commentary/References:
;;; Configure Packages in Emacs core using the amazing `use-package'
;;; a DSL in Emacs Lisp (akin to Common Lisp's `loop' macro).
